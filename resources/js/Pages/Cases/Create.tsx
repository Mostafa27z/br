    ...
    return (
        <Layout title="إضافة حالة جديدة">
            ...
            <div className="mb-8 border-b border-outline-variant/20 pb-sm">
                ...
                <h1 className="font-display-md text-display-md text-on-surface">إضافة حالة اجتماعية جديدة</h1>
            </div>
            ...
            <div className="bg-white rounded-xl border border-outline-variant/30 p-lg shadow-sm max-w-4xl">
                <form onSubmit={handleSubmit} className="space-y-lg text-body-md">
                    ...
                    <div className="pt-md border-t border-outline-variant/20 flex gap-sm justify-end">
                        <Link href={route('cases.index')} className="bg-white border border-outline-variant/30 text-on-surface px-lg py-sm rounded-lg hover:bg-surface-container transition-all">إلغاء</Link>
                        <button 
                            type="submit" 
                            disabled={processing}
